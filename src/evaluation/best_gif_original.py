...
def main():
    ...
    # Create the original LunarLanderContinuous environment
    env = gym.make(
    ...
    output_path = os.path.join(output_dir, "evaluation_report_original.json")
    ...
    save_gif(frames[best_idx], os.path.join(video_dir, "best_episode_original.gif"))
    save_gif(frames[worst_idx], os.path.join(video_dir, "worst_episode_original.gif"))
